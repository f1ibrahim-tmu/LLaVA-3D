...
python llava/eval/sqa3d_evaluator.py \
        --pred-json /root/SceneUnderstanding/LLaVA-3D/experiments/SQA3D/650/llava-3d-7b-sqa3d_test_answer-650-chunk2of2.json \
        --gt-json /data/SceneUnderstanding/7792397/ScanQA_format/SQA_650_formatted_LLaVa3d_answers.json \
        --chunk-idx 1 \
        --num-chunks 2 \
        > /root/SceneUnderstanding/LLaVA-3D/experiments/SQA3D/650/llava-3d-7b-sqa3d_test_answer-650-chunk2of2.txt
